...
- **Parameter yang di gunakan** :
    ...
    d. Parameter lain (default) : n_estimators=100, jumlah pohon.

    e. Parameter lain (default) : learning_rate=0.3, ukuran langkah saat memperbarui bobot.

    f. Parameter lain (default) : max_depth=6, kedalaman maksimal setiap pohon.

    g. Parameter lain (default) : booster='gbtree', subsample=1.0, colsample_bytree=1.0
- **Kekurangan dan kelebihan** :
